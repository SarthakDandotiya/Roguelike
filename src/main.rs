...
use tcod::map::{FovAlgorithm, Map as FovMap}; // Renaming the method Map as it shall conflict with our own dngeon map type
...
fn main() {
    ...
    // computing the "FOV" manually the first time
